...
function sanitizeForHTML(str){return str.replace(/ /g,"&nbsp;");}
...
tr+='</td></tr>';s.push(tr); var tr='<tr class="alignment-mismatch"><td class="alignment-pos alignment-pos-left">';tr+='</td><td>'+sanitizeForHTML(mismatch_rows[i])+'</td><td class="alignment-pos alignment-pos-right">';tr+='</td></tr>';s.push(tr); var tr='<tr class="alignment-subject"><td class="alignment-pos alignment-pos-left">';if(i==0){tr+=''+subject_start}

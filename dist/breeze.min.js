...
console.log("After pruning:");console.log(Object.keys(data).length);console.log("Total children:");console.log(tot_children);console.log("Matched children:");console.log(matched_children);console.log(data);$scope.results=_.map(_.keys(data),function(k){return data[k];});});}
